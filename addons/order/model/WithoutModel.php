 ...
 * @author shilinqing
 */
class WithoutModel extends \web\common\model\BaseModel {
...
//        $c = new \addons\member\model\MemberAccountModel();
//        $sql = 'select tab.*,c.username from '.$this->getTableName().' as tab left join '.$c->getTableName().' c on tab.user_id=c.id';
//        if (!empty($filter))
...
//     * @return type
//     */
//    public function updateBalance($user_id, $amount, $change = false) {
//        $map = array();
//        $map['user_id'] = $user_id;
...
//     * 验证手续费所需可用余额是否足够
//     */
//    public function verifyStock($user_id, $amount) {
//        $where['user_id'] = $user_id;
